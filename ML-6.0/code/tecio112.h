...
integer(c_int32_t) function tecini112( &
  Title, &
  Variables, &
  FName, &
  ScratchDir, &
...
integer(c_int32_t) function teczne112( &
  ZoneTitle, &
  ZoneType, &
  IMxOrNumPts, &
  JMxOrNumElements, &
...
integer(c_int32_t) function tecdat112( &
  N, &
  FieldData, &
  IsDouble) &
  bind (c, name="tecdat112")
  use iso_c_binding
  implicit none
...
integer(c_int32_t) function tecdatf112( &
  N, &
  FieldData) &
  bind (c, name="tecdatf112")
  use iso_c_binding
  implicit none
  integer(c_int32_t), intent(in) :: N
  real(c_float), intent(in)   :: FieldData(*)
end function tecdatf112

integer(c_int32_t) function tecdatd112( &
  N, &
  FieldData) &
  bind (c, name="tecdatd112")
  use iso_c_binding
  implicit none
  integer(c_int32_t), intent(in) :: N
  real(c_double), intent(in)  :: FieldData(*)
end function tecdatd112

integer(c_int32_t) function tecnod112( &
  NData) &
  bind (c, name="tecnod112")
  use iso_c_binding
  implicit none
  integer(c_int32_t), intent(in) :: NData(*)
end function tecnod112

integer(c_int32_t) function tecnode112( &
  N, &
  NData) &
  bind (c, name="tecnode112")
  use iso_c_binding
  implicit none
  integer(c_int32_t), intent(in) :: N
  integer(c_int32_t), intent(in) :: NData(*)
end function tecnode112

integer(c_int32_t) function tecgeo112( &
  XPos, &
  YPos, &
  ZPos, &
  PosCoordMode, &
...
integer(c_int32_t) function tectxt112( &
  XOrThetaPos, &
  YOrRPos, &
  ZOrUnusedPos, &
  PosCoordMode, &
...
integer(c_int32_t) function teclab112( &
  S) &
  bind (c, name="teclab112")
  use iso_c_binding
  implicit none
  character(c_char), intent(in) :: S
end function teclab112

integer(c_int32_t) function tecfil112( &
  F) &
  bind (c, name="tecfil112")
  use iso_c_binding
  implicit none
...
subroutine tecforeign112( &
  ...
  bind (c, name="tecforeign112")
  use iso_c_binding
  implicit none
  integer(c_int32_t), intent(in) :: OutputForeignByteOrder
end subroutine tecforeign112

integer(c_int32_t) function tecend112() &
  bind (c, name="tecend112")
  use iso_c_binding
  implicit none
end function tecend112

integer(c_int32_t) function tecusr112( &
  S) &
  bind (c, name="tecusr112")
  use iso_c_binding
  implicit none
  character(c_char), intent(in) :: S(*)
end function tecusr112

integer(c_int32_t) function tecauxstr112( &
  Name, &
  Value) &
  bind (c, name="tecauxstr112")
  use iso_c_binding
  implicit none
  character(c_char), intent(in) :: Name(*)
  character(c_char), intent(in) :: Value(*)
...
integer(c_int32_t) function teczauxstr112( &
  Name, &
  Value) &
  bind (c, name="teczauxstr112")
  use iso_c_binding
  implicit none
  character(c_char), intent(in) :: Name(*)
  character(c_char), intent(in) :: Value(*)
...
integer(c_int32_t) function tecvauxstr112( &
  Var, &
  Name, &
  Value) &
  bind (c, name="tecvauxstr112")
  use iso_c_binding
  implicit none
...
integer(c_int32_t) function tecface112( &
  FaceConnections) &
  bind (c, name="tecface112")
  use iso_c_binding
  implicit none
  integer(c_int32_t), intent(in) :: FaceConnections(*)
end function tecface112

integer(c_int32_t) function tecpoly112( &
  FaceNodeCounts, &
  FaceNodes, &
  FaceLeftElems, &
  FaceRightElems, &
...
integer(c_int32_t) function tecpolyface112( &
  NumFaces, &
  FaceNodeCounts, &
  FaceNodes, &
  FaceLeftElems, &
  FaceRightElems) &
  bind (c, name="tecpolyface112")
  use iso_c_binding
  implicit none
  ...
  integer(c_int32_t), intent(in) :: FaceLeftElems(*)
  integer(c_int32_t), intent(in) :: FaceRightElems(*)
end function tecpolyface112

integer(c_int32_t) function tecpolybconn112( &
  NumBndryFaces, &
  FaceBndryConnectionCounts, &
  FaceBndryConnectionElems, &
  FaceBndryConnectionZones) &
  bind (c, name="tecpolybconn112")
  use iso_c_binding
  implicit none
  ...
  integer(c_int32_t), intent(in) :: FaceBndryConnectionElems(*)
  integer(c_int32_t), intent(in) :: FaceBndryConnectionZones(*)
end function tecpolybconn112

integer(c_int32_t) function tecfeptn112( &
  partition, &
  numnodes, &
  numcells, &
  ngnodes, &
...
end function tecfeptn112

integer(c_int32_t) function tecijkptn112( &
  partition, &
  imin, &
  jmin, &
  kmin, &
...
end function tecijkptn112

integer(c_int32_t) function tecmpiinit112( &
  communicator, &
  mainrank) &
  bind (c, name="tecmpiinit112")
  use iso_c_binding
  implicit none
  integer(c_int32_t), intent(in) :: communicator
  integer(c_int32_t), intent(in) :: mainrank
end function tecmpiinit112

integer(c_int32_t) function tecznemap112( &
  npartitions, &
  ptnranks) &
  bind (c, name="tecznemap112")
  use iso_c_binding
  implicit none
  integer(c_int32_t), intent(in) :: npartitions
  integer(c_int32_t), intent(in) :: ptnranks(*)
end function tecznemap112
