! ГУ "переменный по времени вток" на X-гранях:
subroutine fx_BndInoutVarT
  use variables
  implicit none
...
end subroutine fx_BndInoutVarT

!===================================================================================================================

! ГУ "переменный по времени вток" на Y-гранях:
subroutine fy_BndInoutVarT
  use variables
  implicit none
...
end subroutine fy_BndInoutVarT
